...
def get_encoder(encoding, input_dim=3, 
    ...
    elif encoding == 'pyramid':
        from gridencoder import GridPyramidEncoder
        encoder = GridPyramidEncoder(input_dim=input_dim, pyramid_levels=pyramid_levels, pyramid_resolution=pyramid_resolution, num_levels=num_levels, level_dim=level_dim, base_resolution=base_resolution, log2_hashmap_size=log2_hashmap_size, desired_resolution=desired_resolution, gridtype='hash', align_corners=align_corners)
    else:
